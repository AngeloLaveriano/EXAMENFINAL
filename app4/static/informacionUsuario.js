...
function cargarInformacionUsuario(idUsuario)
{
    ...
    */
    ...
    datos = {
        'actualizarUsuario':document.getElementById('actualizarUsuario').value,
        'idUsuario':document.getElementById('indUsuario').innerHTML
    }
    fetch(url,
    {
        method:"POST",
    ...
    .then(data => {
        console.log(data)
        cargarInformacionUsuario(document.getElementById('indUsuario').innerHTML)
        document.getElementById('actualizarUsuario').value = ''
    })
}